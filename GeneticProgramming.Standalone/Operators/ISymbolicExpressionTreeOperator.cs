...
namespace GeneticProgramming.Operators
{
    ...
    /// </summary>
    public interface ISymbolicExpressionTreeOperator<T> : IOperator, IDeepCloneable, INotifyPropertyChanged where T : struct
    {
        /// <summary>
    ...
    /// </summary>
    public interface ISymbolicExpressionTreeCreator<T> : ISymbolicExpressionTreeOperator<T> where T : struct
    {
        /// <summary>
    ...
    /// </summary>
    public interface ISymbolicExpressionTreeCrossover<T> : ISymbolicExpressionTreeOperator<T> where T : struct
    {
        /// <summary>
    ...
    /// </summary>
    public interface ISymbolicExpressionTreeMutator<T> : ISymbolicExpressionTreeOperator<T> where T : struct
    {
        /// <summary>
